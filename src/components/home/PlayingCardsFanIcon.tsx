...
/**
 * Lucide `playing-cards-fan` — 설치본 0.562에 없어 공식 SVG를 로컬로 둔다 (ISC)
 */
const PlayingCardsFanIcon = forwardRef<SVGSVGElement, LucideProps>(
  function PlayingCardsFanIcon(
    {
      color = "currentColor",
      size = 24,
      strokeWidth = 2,
...
export default PlayingCardsFanIcon as LucideIcon;
