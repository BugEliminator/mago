...
/** 로컬 해석 모드 — 정방향 78 + 역방향 78 */
export const INTERPRET_CATALOG_COUNT = TOTAL_CARDS * 2;
export const INTERPRET_SPREAD_ROW_COUNT = Math.ceil(
  INTERPRET_CATALOG_COUNT / CARDS_PER_ROW,
);
export const INTERPRET_SPREAD_ROW_CENTER =
  (INTERPRET_SPREAD_ROW_COUNT - 1) / 2;
...
export const INTERPRET_SPREAD_STAGE_MIN_HEIGHT_PX =
  (INTERPRET_SPREAD_ROW_COUNT - 1) * SPREAD_ROW_SPACING +
  SPREAD_CARD_HEIGHT_PX +
  280;
